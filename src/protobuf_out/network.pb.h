...
const int Player_ClassType_ClassType_ARRAYSIZE = Player_ClassType_ClassType_MAX + 1;
...
const int Player_PetType_PetType_ARRAYSIZE = Player_PetType_PetType_MAX + 1;
...
class Player_Pet : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:TLMP.NetworkMessages.Player.Pet)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
...
class Player : public ::google::protobuf::Message {
 public:
  ...
  static const int ClassType_ARRAYSIZE =
    Player_ClassType_ClassType_ARRAYSIZE;
  ...
  static const int PetType_ARRAYSIZE =
    Player_PetType_PetType_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  PetType_descriptor() {
  ...
  // @@protoc_insertion_point(class_scope:TLMP.NetworkMessages.Player)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
